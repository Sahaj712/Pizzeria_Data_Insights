...
CREATE TABLE `address` (
    ...
    `delivery_zipcode` vrchar(20)  NOT NULL ,
    PRIMARY KEY (
        `add_id`
    )
);
...
CREATE TABLE `rota` (
    ...
    `shift__id` varchar(20)  NOT NULL ,
    `staff_if` varchar(20)  NOT NULL ,
    PRIMARY KEY (
        `row_id`
    )
);
